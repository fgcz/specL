...
abstract: >
  ...
  system and is meant for training and reproducibility.
vignette: >
...
file.copy(system.file("doc", "report.Rmd", package = "specL"), report_file); 
rmarkdown::render(report_file, output_format='html_document', output_file='/tmp/report_specL.html')
```       
